...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.333, 123.323],
    // zoom: 5,
    // interactive: false
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (updateData) {
              (0, _alerts.showAlert)('success', "success ".concat(type.toUpperCase(), " updates successfully"));
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51KFCwBC73OZSGGrxpw5IYy8MAmhVUTgKik6P2oVPHUu5GLDOSQEwRVHKnyWazMz5bkWJSsJwcPMrdjwc2hHlEp3a00YIQhzHLX');
...
if (mapBox) {
  ...
  var locations = JSON.parse(mapBox === null || mapBox === void 0 ? void 0 : (_mapBox$dataset = mapBox.dataset) === null || _mapBox$dataset === void 0 ? void 0 : _mapBox$dataset.locations);
