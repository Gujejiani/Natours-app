      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'We are glad to see you with us!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
if (form) {
  form.addEventListener('submit', function (e) {
    ...
    if (!confirmPassword) {
      ...
      _form.append('confirmPassword', confirmPassword);

      _form.append('photo', photo);

      _form.append('role', 'user');

      _form.append('signUp', true);

      if (signUpBtn) {
        signUpBtn.textContent = "Processing...";
      }

      (0, _login.signUp)(_form);
    }
  });
}
